 ...
 * Gerencia obrigatoriedade, prevenção de tags HTML, regras de validação e formatação do valor recebido.
 */
class InputField
{
    /** @ignore */
     ...
     * @param mixed $value Valor inicial do campo.
     */
     ...
     * @param string $message Mensagem de erro (suporta chaves de InputMessage e tags de prepare).
     * @param bool|int $status Status HTTP (false usa STS_BAD_REQUEST, true usa STS_OK).
     * @param array $prepare Variáveis adicionais para interpolação na mensagem.
     */
     ...
     * @param string|null $errorMessage Mensagem de erro personalizada.
     * @param int|null $errorStatus Status HTTP do erro.
     * @return static
     */
     ...
     * @param int|Closure|InputField $rule Constante FILTER_VALIDATE_*, Closure ou outro InputField para comparação de igualdade.
     * @param string|null $errorMessage Mensagem de erro personalizada.
     * @param int|null $errorStatus Status HTTP do erro.
     * @return static
     */
     ...
     * @param int|Closure $rule Constante FILTER_SANITIZE_* ou Closure de transformação.
     * @return static
     */
     ...
     * @param bool $preventTag Se a proteção está ativa.
     * @param string|null $errorMessage Mensagem de erro personalizada.
     * @param int|null $errorStatus Status HTTP do erro.
     * @return static
     */
     ...
     * @param bool|array $scapePrepare True para escapar todas, false para nenhuma, array para tags específicas.
     * @return static
     */
