# `Model\DbMain\Record\RecordUserGroup`
...
- `protected $DATALAYER` `string` —  _(herdado de `Model\DbMain\Driver\DriverRecordUserGroup`)_
- `protected $TABLE` `string` —  _(herdado de `Model\DbMain\Driver\DriverRecordUserGroup`)_
- `public $name` `\PhpMx\Datalayer\Driver\Field\FVarchar` — Nome do grupo _(herdado de `Model\DbMain\Driver\DriverRecordUserGroup`)_
