...
/**
 * Classe utilitária para gerenciamento de mensagens de erro de inputs.
 * Centraliza as mensagens padrão para regras de validação, permitindo personalização global.
 */
abstract class InputMessage
{
     ...
     * @param int|string $type Constante FILTER_VALIDATE_* ou chave textual (ex: 'required', 'equal').
     * @param string|null $message Mensagem a associar ao tipo (suporta tags de prepare como [#name]).
     */
     ...
     * @param string $type Constante FILTER_VALIDATE_* ou chave textual.
     * @return string|null
     */
