 ...
 * @param string $method Método HTTP da rota (get, post, put, delete, full, add).
 * @param string $template Template da rota (ex: 'users/[#id]').
 * @param string $response Classe de resposta em dot.notation ou status HTTP.
 * @param string|null $responseMethod Método da classe de resposta (opcional).
 */
return new class {
