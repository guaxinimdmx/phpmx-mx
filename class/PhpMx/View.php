...
abstract class View
{
     ...
     * @param string $ref Referência da view (namespace ou caminho relativo).
     * @param string|array $data Dados disponíveis como variáveis na view.
     * @param array $params Parâmetros adicionais de renderização.
     * @return string
     */
     ...
     * @param string $viewContent Conteúdo a ser processado.
     * @param string|array $data Dados disponíveis como variáveis na string.
     * @return string
     */
     ...
     * @param string $media Identificador da media query (ex: 'mobile').
     * @param string $queries Valor real da media query (ex: 'max-width: 768px').
     */
     ...
     * @param string $tag Nome da tag de prepare.
     * @param mixed $action Valor ou callable associado à tag.
     */
